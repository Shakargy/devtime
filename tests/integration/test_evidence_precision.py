...
def test_version_is_release_0_5_1():
    # v0.5.1 release: package metadata and __version__ agree on the release version.
    import importlib.metadata as m

    assert devtime.__version__ == "0.5.1"
    ...
    assert m.version("devtime-ei") == "0.5.1"
