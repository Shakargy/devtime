...
def test_version_is_release_0_6_0():
    # v0.6.0 release: package metadata and __version__ agree on the release version.
    import importlib.metadata as m

    assert devtime.__version__ == "0.6.0"
    ...
    assert m.version("devtime-ei") == "0.6.0"
