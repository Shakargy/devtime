...
def test_version_is_release_0_7_0():
    # v0.7.0 release: package metadata and __version__ agree on the release version.
    import importlib.metadata as m

    assert devtime.__version__ == "0.7.0"
    ...
    assert m.version("devtime-ei") == "0.7.0"
